        ...
        <div style={{
          ...
          <div style={{ marginBottom: '2rem', animation: 'fadeIn 0.4s ease' }}>
            ...
            <p style={{ fontSize: '0.9rem', color: colors.textMuted }}>
              Add 2 to 4 GitHub usernames and compare their profiles side by side
            </p>
          </div>
          ...
          {loading && (
            <div style={{
              ...
              <p style={{ color: colors.textMuted, fontSize: '0.8rem', marginTop: '4px' }}>
          ...
          {!loading && results && (
            <div style={{ animation: 'fadeIn 0.4s ease' }}>
              ...
              <div
                ...
                style={{
                  display:             'grid',
                  gridTemplateColumns: `repeat(${Math.min(results.results.length, 2)}, 1fr)`,
                  gap:                 '1rem',
                  marginBottom:        '1.5rem',
                }}
              >
